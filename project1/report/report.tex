...
% TODO relatar tempo de execução V5
...
However, we have not been successful in developing these versions, and some errors cause longer execution times and erroneous results. Due to this fact, this version will be excluded from our analyses.
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tikzpicture}
        ...
        \begin{axis}[
            ylabel={Execution time (seconds)},
            xlabel={Version},
symbolic x coords={V2, V3, V4, V5, V9, V10},
xtick=data,
nodes near coords={
    \pgfmathprintnumber[precision=1]{\pgfplotspointmeta}
  },
