...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      % V2
      \addplot
      coordinates {(1000, 3.596356) (100, 8.412381) (10, 59.388425) (1, 564.774576)};
      % V6 
      \addplot
      coordinates {(1000, 2.658484) (100, 8.265419) (10, 58.153837) (1, 277.208141)};
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
        ...
        ylabel={Execution time (seconds)},
        xlabel={Number of steps between output},
        symbolic x coords={200x200, 400x400, 800x800, 2000x2000},
        xtick=data,
        bar width = 17pt,
        nodes near coords={
            \pgfmathprintnumber[precision=1]{\pgfplotspointmeta}
      ...
      % V2
      \addplot
      coordinates {(200x200, 3.596356) (400x400, 9.045749) (800x800, 37.804506) (2000x2000, 247.119578)};
      % V6 
      \addplot
      coordinates {(200x200, 2.658484) (400x400, 9.047637) (800x800, 37.634587) (2000x2000, 243.798113)};
